...
function aiLogic() {
    ...
    function getRandomCell() {
        ...
        // let attackCoords = this.availableAttacks[arrayRow].splice(arrayCol, 1)[0];
        let attackCoords = this.availableAttacks[arrayRow][arrayCol];
        // if (this.availableAttacks[arrayRow].length === 0) this.availableAttacks.splice(arrayRow, 1);
        // this.removeCellFromAvailableAttacks
        console.log(`got ${attackCoords}`)
        return attackCoords;
    }
    function removeCellFromAvailableAttacks(cell){
        console.log(`attempting to remove ${cell}`)
